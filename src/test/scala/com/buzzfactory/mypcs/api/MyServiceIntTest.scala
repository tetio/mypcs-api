...
import com.buzzfactory.mypcs.api.Mongo.Persons
import com.buzzfactory.mypcs.api.models.Person
...
class MyServiceIntTest
  ...
  describe("MyService - person") {
    ...
    describe("PUT") {
      ...
      it("should return OK on a put request and perform a database insert") {
